...
var qntGetDataBySelector = function (selector, concretData) {

    var elem = document.querySelector(selector);

    if (concretData) {
        return elem.dataset.concretData
    }
...
var qntGetThisData = function (_this, concretData) {
    ...
    if (concretData && _this.dataset.hasOwnProperty(concretData)) {
        return _this.dataset[concretData]
    }
